...
import likeIcon from "../../../assests/like-svgrepo-com.svg";
import redLikeIcon from "../../../assests/redLike.svg";
import commentIcon from "../../../assests/comment.svg";
import deletePost from "../../../assests/trash-solid.svg";
...
import { addFriendAction } from "../../../actions/addFriend";
...
const Post = ({ postProp }) => {
  ...
  const addFriendHandler = () => {
    ...
    dispatch(
      addFriendAction(post?.userPosted?.userId, {
