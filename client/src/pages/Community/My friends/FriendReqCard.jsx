...
import { acceptRequestAction } from "../../../actions/addFriend";
import { removeRequestAction } from "../../../actions/addFriend";
...
const FriendReqCard = ({ allRequests }) => {
  ...
  const acceptRequestHandler = () => {
    dispatch(
      acceptRequestAction(
        { _id: currentUser?.result?._id, userName: currentUser?.result?.name },
        requests
      )
    );
  };
  ...
  const rejectRequestHandler = () => {
    dispatch(
      removeRequestAction(currentUser?.result?._id, { objId: requests._id })
    );
  };
